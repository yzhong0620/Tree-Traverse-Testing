...
/**
 * Create a full tree with 7 nodes
 */
public class fullTree {
    ...
    /**
     * Opens a new CanvasWindow showing this full tree
     */
    public fullTree() {
        canvas = new CanvasWindow("Full Tree!", CANVAS_WIDTH, CANVAS_HEIGHT);
