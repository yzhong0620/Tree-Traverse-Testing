...
/**
 * Create a complete tree with 6 nodes
 */
public class completeTree {
    ...
    /**
     * Opens a new CanvasWindow showing this complete tree
     */
    public completeTree() {
        canvas = new CanvasWindow("Complete Tree!", CANVAS_WIDTH, CANVAS_HEIGHT);
    ...
    public void setUp(){
        ...
        bt = new BinaryTree(0,new BinaryTree(1,new BinaryTree(3, null,null), new BinaryTree(4, null, null)),
                new BinaryTree(2, new BinaryTree(5, null, null), null));
        ...
        reset.onClick(()->new completeTree());
